...
const HE_PROOF_EXAMPLES: ProofExample[] = [
  {
    ...
    subtitle: "דוגמת קמפיין למרפאת שתלים בארה״ב שהתמקדה במטופלי Full-Arch.",
    ...
    result:
      "הקמפיין עבר מאופטימיזציה למילוי טפסים קל לאופטימיזציה לפניות Full-Arch איכותיות יותר. התוצאות משתנות לפי אזור, הצעה, מעקב וקיבולת המרפאה.",
    metrics: [
      { label: "מודל ROI מעוגל", value: "38x" },
      { label: "הזדמנות רצינית ראשונה", value: "7 ימים" },
      { label: "יעד אופטימיזציה", value: "פניות מסוננות" },
    ],
    relatedServices: [
      "dental-implant-marketing",
      "all-on-4-dental-implant-marketing",
  ...
  },
  {
    ...
    approach:
      "הקמפיין שילב קריאייטיב בסגנון UGC, מסר סביב תוצאה, סינון התאמה תקציבית ומדידה של איכות הפניות האסתטיות.",
    result:
      "צוות המרפאה קיבל פניות קוסמטיות ברורות יותר והקשר טוב יותר לפני המעקב. התוצאות משתנות לפי אזור, ערך מקרה, קריאייטיב ותהליך סגירה.",
    metrics: [
  ...
  },
  {
    ...
    subtitle: "דוגמה לאופן שבו פניות שאושרו או נדחו משפרות את איכות הגיוס.",
    ...
    result:
      "החלטות תקציב הפכו ברורות יותר כי המרפאה יכלה להפריד בין פעילות רועשת לבין פניות עם פוטנציאל אמיתי. התוצאות משתנות לפי איכות הנתונים והמעקב.",
    metrics: [
