...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription:
      "Learn how to get dental implant patients with a practical strategy for ads, lead handling, and consult conversion that drives real ROI.",
  ...
  },
  {
    ...
    metaDescription:
      "See 9 UGC dental ads examples that help implant and cosmetic clinics turn Meta traffic into qualified consult calls and better ROI fast.",
    title: "9 UGC Dental Ads Examples That Book Consults",
    excerpt:
    ...
    sections: [
      ...
      {
        heading: "How to turn these examples into actual booked calls",
        paragraphs: [
  ...
  },
  {
    ...
    metaDescription:
      "Learn why dental ads fail, from weak offers to poor targeting, and how implant and cosmetic clinics can turn ad spend into consult calls.",
    ...
    sections: [
      ...
      {
        heading: "The practice is optimizing for leads, not consults",
        paragraphs: [
  ...
  },
  {
    ...
    metaDescription:
      "The best dental lead sources for implant and cosmetic clinics, ranked by speed, intent, cost, and ROI so you can book more qualified consults.",
    ...
    sections: [
      ...
      {
        heading: "3. Google Business Profile drives local calls you do not have to manufacture",
        paragraphs: [
  ...
  },
  {
    ...
    metaDescription:
      "Google ads vs facebook ads dentists: see which channel drives more implant and cosmetic consults, faster ROI, and better lead quality.",
  ...
  {
    slug: "how-cosmetic-dentists-get-more-consults",
    metaDescription:
      "Learn how to market cosmetic dentistry with ads, offers, and follow-up that drive more qualified consults, faster ROI, and better case acceptance.",
    title: "How Cosmetic Dentists Get More Consults",
    excerpt:
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Cosmetic patients do not usually book because they stumbled across a generic dental ad. They book when the offer is clear, the before-and-after outcome feels believable, and the path to consultation is easy.",
        ],
      },
      {
      ...
      {
        heading: "Your landing page should sell the consult, not the whole treatment",
        paragraphs: [
  ...
  },
  {
    ...
    metaDescription:
      "See what a dentist growth agency should actually do to generate more consults, better lead quality, and measurable ROI for implant and cosmetic clinics.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "That is why a serious growth agency should care about follow-up speed, scripts, appointment-setting process, and how booked consults are tracked. Too many agencies stop at cost per lead. A growth agency should care about cost per booked consult, show rate, acceptance rate, and revenue generated from closed cases.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The best dentist growth agency is not the one that talks the most about marketing. It is the one that understands how to turn attention into consultations, consultations into cases, and cases into predictable revenue. That is what growth looks like when it is built correctly.",
        ],
      },
    ],
  },
  {
    ...
    metaDescription:
      "Learn how dentist patient growth actually happens for implant and cosmetic clinics and how to turn marketing into a predictable pipeline of qualified consults.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The strongest dentist patient growth systems use both channels strategically. Google captures patients who are already searching. Meta introduces treatment opportunities to people who are aware of the problem but have not taken action yet. Together they create a stronger and more stable consultation pipeline.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The page should remove uncertainty rather than create extra decisions. When designed correctly, a landing page turns curiosity into action. This step alone can dramatically improve dentist patient growth because it increases the percentage of visitors who actually book consultations.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The result is a steady flow of qualified consultations rather than random inquiries. Dentist patient growth does not come from chasing every marketing trend. It comes from building a patient acquisition system that consistently turns attention into appointments and appointments into treatment.",
  ...
  },
  {
    ...
    metaDescription:
      "Learn what dental office marketing should actually do for implant and cosmetic clinics, and how to turn attention into qualified consult calls and real ROI.",
    ...
    sections: [
      ...
      {
        heading: "A landing page should sell the consultation, not the whole practice",
        paragraphs: [
